...
<form method="POST" enctype="multipart/form-data" id="methodEditForm">
    ...
    <div class="white_box p-15 box_shadow_white mb-20">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="primary_input mb-15">
                    <label class="primary_input_label" for=""> {{__("Minimum Shopping Amount")}}</label>
                    <input class="primary_input_field" name="minimum_shopping" id="minimum_shopping" placeholder="{{__("Minimum Shopping Amount")}}" type="number" min="0" step="{{step_decimal()}}" value="{{$shipping_method->minimum_shopping}}">
