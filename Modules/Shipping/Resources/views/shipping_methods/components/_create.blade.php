        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="primary_input mb-15">
                    ...
                    <input class="primary_input_field" name="minimum_shopping" id="minimum_shopping" placeholder="{{__("Minimum Shopping Amount")}}" type="number" min="0" step="{{step_decimal()}}" value="{{old('minimum_shopping')}}">
