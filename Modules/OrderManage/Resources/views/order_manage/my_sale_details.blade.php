                            ...
                            <div class="col-md-6 col-lg-6">
                                <table class="table-borderless clone_line_table">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="mailto:{{($order->customer_id) ? @$order->address->billing_email : $order->guest_info->billing_email}}">: {{($order->customer_id) ? @$order->address->billing_email : $order->guest_info->billing_email}}</a></td>
                                    </tr>
                                    <tr>
                                        <td>{{__('common.phone')}}</td>
                                        <td>: {{($order->customer_id) ? @$order->address->billing_phone : @$order->guest_info->billing_phone}}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>: {{($order->customer_id) ? @$order->address->billing_postcode : @$order->guest_info->billing_post_code}}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-6 col-lg-6">
                        ...
                        <div class="row mt-30">
                            <div class="col-md-6 col-lg-6">
                                <table class="table-borderless clone_line_table">
                                    ...
                                    <tr>
                                        <td>{{__('common.email')}}</td>
                                        <td><a href="mailto:{{($order->customer_id) ? @$order->address->shipping_email : @$order->guest_info->shipping_email}}">: {{($order->customer_id) ? @$order->address->shipping_email : @$order->guest_info->shipping_email}}</a></td>
                                    </tr>
                                    <tr>
                                        <td>{{__('common.phone')}}</td>
                                        <td>: {{($order->customer_id) ? @$order->address->shipping_phone : @$order->guest_info->shipping_phone}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{__('common.address')}}</td>
                                    ...
                                    <tr>
                                        <td>{{__('common.postcode')}}</td>
                                        <td>: {{($order->customer_id) ? @$order->address->shipping_postcode : @$order->guest_info->shipping_post_code}}</td>
                                    </tr>
                                </table>
                            </div>
                            @php
