...
Route::middleware(['auth','admin','permission'])->prefix('appearance')->as('appearance.')->group(function() {
    ...
    Route::get('/pre-loader', 'PreloaderSettingController@index')->name('pre-loader');
    Route::post('/pre-loader', 'PreloaderSettingController@update')->name('pre-loader.update')->middleware('prohibited_demo_mode');
